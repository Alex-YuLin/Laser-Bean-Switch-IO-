...
namespace GalvoScan.Hardware.Key
{
    class Key_Interface
    {
    }
...
namespace GalvoScan.Hardware.Key.ErrCode
{
    class Num   // -601 ~ -700
    {
...
namespace GalvoScan.Hardware.Key.Define
{
    struct HWType
    {
    ...
    enum Galvo
    {
        na=99, LightningII=1, RTC3=2, RTC5=3, Dummy = 0,
    }
    enum AI
    {
        na = 99, U500 = 1, A3200 = 2, L112 = 3, L122 = 4, Dummy = 0,
